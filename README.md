[![Build Status](https://travis-ci.org/odczynflnpm/necessitatibus-numquam-aut.svg?branch=master)](https://travis-ci.org/odczynflnpm/necessitatibus-numquam-aut)
[![npm (scoped)](https://img.shields.io/npm/v/menubar.svg)](https://www.npmjs.com/package/menubar)
[![dependencies Status](https://david-dm.org/odczynflnpm/necessitatibus-numquam-aut/status.svg)](https://david-dm.org/odczynflnpm/necessitatibus-numquam-aut)
...
- To create a native menu, you can use `tray.setContextMenu(contextMenu)`, and pass this custom tray to menubar: `const mb = menubar({ tray });`. See [this example](https://github.com/odczynflnpm/necessitatibus-numquam-aut/tree/master/examples/native-menu) for more information.
